...
"}")
        ...
        self.pageItemComments.setGeometry(QtCore.QRect(0, 0, 801, 373))
        ...
        self.pageItemGetRid.setGeometry(QtCore.QRect(0, 0, 801, 373))
        ...
        self.pageItemTagWords.setGeometry(QtCore.QRect(0, 0, 801, 373))
        ...
        self.pageItemStop = QtWidgets.QWidget()
        self.pageItemStop.setGeometry(QtCore.QRect(0, 0, 801, 373))
        self.pageItemStop.setObjectName("pageItemStop")
        self.tableViewStop = QtWidgets.QTableView(self.pageItemStop)
        self.tableViewStop.setGeometry(QtCore.QRect(0, 0, 801, 381))
        self.tableViewStop.setObjectName("tableViewStop")
        self.toolBoxPraise.addItem(self.pageItemStop, "")
        ...
        self.pageItemComments_2.setGeometry(QtCore.QRect(0, 0, 801, 373))
        ...
        self.pageItemGetRid_2.setGeometry(QtCore.QRect(0, 0, 801, 373))
        ...
        self.pageItemTagWords_2.setGeometry(QtCore.QRect(0, 0, 801, 373))
        ...
        self.pageItemStop_2 = QtWidgets.QWidget()
        self.pageItemStop_2.setGeometry(QtCore.QRect(0, 0, 801, 373))
        self.pageItemStop_2.setObjectName("pageItemStop_2")
        self.tableViewStop_2 = QtWidgets.QTableView(self.pageItemStop_2)
        self.tableViewStop_2.setGeometry(QtCore.QRect(0, 0, 801, 381))
        self.tableViewStop_2.setObjectName("tableViewStop_2")
        self.toolBoxBad.addItem(self.pageItemStop_2, "")
...
"}")
        ...
        self.pageItemGetRid_3.setGeometry(QtCore.QRect(0, 0, 801, 373))
        ...
        self.pageItemTagWords_3.setGeometry(QtCore.QRect(0, 0, 801, 373))
        ...
        self.pageItemStop_3 = QtWidgets.QWidget()
        self.pageItemStop_3.setGeometry(QtCore.QRect(0, 0, 801, 373))
        self.pageItemStop_3.setObjectName("pageItemStop_3")
        self.tableViewStop_4 = QtWidgets.QTableView(self.pageItemStop_3)
        self.tableViewStop_4.setGeometry(QtCore.QRect(0, 0, 811, 381))
        self.tableViewStop_4.setObjectName("tableViewStop_4")
        self.toolBoxPraise_2.addItem(self.pageItemStop_3, "")
        ...
        self.pageItemGetRid_4.setGeometry(QtCore.QRect(0, 0, 801, 373))
        ...
        self.pageItemTagWords_4.setGeometry(QtCore.QRect(0, 0, 801, 373))
        ...
        self.pageItemStop_4 = QtWidgets.QWidget()
        self.pageItemStop_4.setGeometry(QtCore.QRect(0, 0, 801, 373))
        self.pageItemStop_4.setObjectName("pageItemStop_4")
        self.tableViewStop_3 = QtWidgets.QTableView(self.pageItemStop_4)
        self.tableViewStop_3.setGeometry(QtCore.QRect(0, 0, 801, 381))
        self.tableViewStop_3.setObjectName("tableViewStop_3")
        self.toolBoxBad_2.addItem(self.pageItemStop_4, "")
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1069, 599))
...
"评"))
        ...
        self.toolBoxPraise.setItemText(self.toolBoxPraise.indexOf(self.pageItemGetRid), _translate("Archievements", "过滤"))
        self.toolBoxPraise.setItemText(self.toolBoxPraise.indexOf(self.pageItemTagWords), _translate("Archievements", "分词标注"))
        self.toolBoxPraise.setItemText(self.toolBoxPraise.indexOf(self.pageItemStop), _translate("Archievements", "去停用词"))
        self.toolBoxBad.setItemText(self.toolBoxBad.indexOf(self.pageItemComments_2), _translate("Archievements", "原评论"))
        self.toolBoxBad.setItemText(self.toolBoxBad.indexOf(self.pageItemGetRid_2), _translate("Archievements", "过滤"))
        self.toolBoxBad.setItemText(self.toolBoxBad.indexOf(self.pageItemTagWords_2), _translate("Archievements", "分词标注"))
        self.toolBoxBad.setItemText(self.toolBoxBad.indexOf(self.pageItemStop_2), _translate("Archievements", "去停用词"))
...
"评"))
        ...
        self.toolBoxPraise_2.setItemText(self.toolBoxPraise_2.indexOf(self.pageItemGetRid_3), _translate("Archievements", "过滤"))
        self.toolBoxPraise_2.setItemText(self.toolBoxPraise_2.indexOf(self.pageItemTagWords_3), _translate("Archievements", "分词标注"))
        self.toolBoxPraise_2.setItemText(self.toolBoxPraise_2.indexOf(self.pageItemStop_3), _translate("Archievements", "去停用词"))
        self.toolBoxBad_2.setItemText(self.toolBoxBad_2.indexOf(self.pageItemComments_4), _translate("Archievements", "原评论"))
        self.toolBoxBad_2.setItemText(self.toolBoxBad_2.indexOf(self.pageItemGetRid_4), _translate("Archievements", "过滤"))
        self.toolBoxBad_2.setItemText(self.toolBoxBad_2.indexOf(self.pageItemTagWords_4), _translate("Archievements", "分词标注"))
        self.toolBoxBad_2.setItemText(self.toolBoxBad_2.indexOf(self.pageItemStop_4), _translate("Archievements", "去停用词"))
