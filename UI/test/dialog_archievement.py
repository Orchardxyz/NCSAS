...
"}")
        ...
        self.pageItemComments.setGeometry(QtCore.QRect(0, 0, 801, 410))
        ...
        self.pageItemGetRid.setGeometry(QtCore.QRect(0, 0, 801, 410))
        ...
        self.pageItemTagWords.setGeometry(QtCore.QRect(0, 0, 801, 410))
        ...
        self.pageItemComments_2.setGeometry(QtCore.QRect(0, 0, 801, 410))
        ...
        self.pageItemTagWords_2.setGeometry(QtCore.QRect(0, 0, 801, 410))
...
"}")
        ...
        self.pageItemComments_3.setGeometry(QtCore.QRect(0, 0, 801, 410))
        ...
        self.pageItemGetRid_3.setGeometry(QtCore.QRect(0, 0, 801, 410))
        ...
        self.pageItemTagWords_3.setGeometry(QtCore.QRect(0, 0, 801, 410))
        ...
        self.pageItemComments_4.setGeometry(QtCore.QRect(0, 0, 801, 410))
        ...
        self.pageItemTagWords_4.setGeometry(QtCore.QRect(0, 0, 801, 410))
...
"}")
        ...
        self.toolBoxBad.setCurrentIndex(2)
        self.stackedWidgetContentHp.setCurrentIndex(0)
        self.toolBoxPraise_2.setCurrentIndex(2)
        self.toolBoxBad_2.setCurrentIndex(2)
...
"评"))
        self.labelTips.setText(_translate("Archievements", "点击不同按钮即可选择查看不同评价的预处理数据"))
...
"评"))
        self.labelTips_2.setText(_translate("Archievements", "点击不同按钮即可选择查看不同评价的预处理数据"))
